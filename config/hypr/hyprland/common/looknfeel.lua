...
hl.config({
	general = {
		...
		float_gaps = { top = 0, right = 20, bottom = 20, left = 20 },
		border_size = 2,

		col = {
			active_border = { colors = { "rgba(8839efee)", "rgba(ea76cbee)" }, angle = 45 },
...
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 2, bezier = "almostLinear", style = "slidevert" })
